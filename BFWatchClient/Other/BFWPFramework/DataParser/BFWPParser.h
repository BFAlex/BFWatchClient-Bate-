...
/**
 登录失败
 */
- (void)bfWPDidLoginFail:(NSDictionary *)json reason:(NSString *)reason;

/**
 退出登录成功
 */
- (void)bfWPDidLogout:(NSDictionary *)json;
/**
 退出登录失败
 */
- (void)bfWPDidLogoutFail:(NSDictionary *)json reason:(NSString *)reason;

/**
 各种在线事件推送,但通讯录和聊天消息等需 app 自行调用上行接口获取
 */
- (void)bfWPNotify:(NSDictionary*)json key:(NSString*)key data:(id)data;

/**
 被逼下线
 */
- (void)bfWPLoginConflict:(NSDictionary*)json reason:(NSString*)reason;
